module Player.Medium(playerMedium) where

import Types  --(Player(..), Tile(EmptyTile), Board, Move, validMoves, put, flipTile,(??))
...
teamMembers :: String 
teamMembers = "Jaime Azcorra-Sedano, Andres Anhalzer"

playerMedium :: Player 
playerMedium = Player computeMove "Medium"

------------------------------------------------validMoves------------------------------------------------------
----------------------------------------------------------------------------------------------------------------


incremMoves :: Move -> Int8 -> Int8
incremMoves (row,col) intMove = error "undefined"


{-
validMoves :: Board -> [Move]
validMoves board  = giveBack board c
	where
...
computeMove tile board 
  ...
  where
        ...
        moves       = trace ("mo: " ++ show (validMoves board)) $ validMoves board
